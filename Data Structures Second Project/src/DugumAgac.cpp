...
DugumAgac::DugumAgac(Doku* doku)    //Kurucu fonksiyon. Parametre aldigi doku cinsinden adresi kendi doku degiskenine atar. Boylece doku bilgisi agacta saklanmis olur.
{
    this->doku = doku;
    sol = sag = 0;
    yukseklik = 0;
